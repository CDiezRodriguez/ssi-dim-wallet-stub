...
public class TestUtils {
    ...
    @SneakyThrows
    public static String createAOauthToken(String clientId, TestRestTemplate restTemplate, ServiceUtils serviceUtils, TokenSettings tokenSettings) {
        ...
        return verifyTokenResponse(response, clientId, serviceUtils, tokenSettings);
    }


    public static String verifyTokenResponse(ResponseEntity<TokenResponse> response, String bpn, ServiceUtils serviceUtils, TokenSettings tokenSettings) throws ParseException {
        ...
        //verify token
        JWTClaimsSet jwtClaimsSet = serviceUtils.verifyTokenAndGetClaims(tokenResponse.getAccessToken());
     ...
     * @param serviceUtils        The ServiceUtils used for token-related and cryptographic operations.
     ...
     */
    public String getVPToken(TestRestTemplate restTemplate, ServiceUtils serviceUtils, DidDocumentService didDocumentService,
                             TokenSettings tokenSettings, String consumerDid, String providerDid, String consumerBpn, String readScope, List<String> typeList) throws URISyntaxException {
        String requestedInnerToken = getToken(serviceUtils, didDocumentService, consumerDid, providerDid, consumerBpn, readScope, typeList);
        String jwt = createStsWithoutScope(restTemplate, serviceUtils, tokenSettings, consumerDid, providerDid, consumerBpn, requestedInnerToken);
        HttpHeaders headers = new HttpHeaders();
    ...
    private String createStsWithoutScope(TestRestTemplate restTemplate, ServiceUtils serviceUtils, TokenSettings tokenSettings, String consumerDid, String providerDid, String consumerBpn, String token) {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.add(HttpHeaders.AUTHORIZATION, TestUtils.createAOauthToken(consumerBpn, restTemplate, serviceUtils, tokenSettings));
    ...
    private static String getToken(ServiceUtils serviceUtils, DidDocumentService didDocumentService, String consumerDid, String providerDid, String consumerBpn, String scope, List<String> vcTypes) {
        JWTClaimsSet tokeJwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .build();
        return CommonUtils.signedJWT(tokeJwtClaimsSet, serviceUtils.getKeyPair(consumerBpn), didDocumentService.getDidDocument(consumerBpn).getVerificationMethod().get(0).getId()).serialize();
    }
}
