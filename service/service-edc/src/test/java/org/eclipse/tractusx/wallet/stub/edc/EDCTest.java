...
class EDCTest {
    ...
    void testQueryPresentationWithoutScopedSTS() {
        ...
        JWTClaimsSet jwtClaimsSet = serviceUtils.verifyTokenAndGetClaims(vpToken);
        ...
        JWTClaimsSet vcClaims = serviceUtils.verifyTokenAndGetClaims(vc);
        ...
        vcClaims = serviceUtils.verifyTokenAndGetClaims(vc);
    ...
    void testCreateStsWithoutScope() {
        ...
        //validate STS
        JWTClaimsSet jwtClaimsSet = serviceUtils.verifyTokenAndGetClaims(stsToken);
        ...
        JWTClaimsSet innerTokenClaim = serviceUtils.verifyTokenAndGetClaims(innerToken);
    ...
    void testCreateSTSTokenWithScope() {
        ...
        //validate STS
        JWTClaimsSet jwtClaimsSet = serviceUtils.verifyTokenAndGetClaims(jwt);
    ...
    private String getToken(String consumerDid, String providerDid, String consumerBpn, String scope, List<String> vcTypes) {
        JWTClaimsSet tokeJwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .build();
        return CommonUtils.signedJWT(tokeJwtClaimsSet, serviceUtils.getKeyPair(consumerBpn), didDocumentService.getDidDocument(consumerBpn).getVerificationMethod().getFirst().getId()).serialize();
    }
